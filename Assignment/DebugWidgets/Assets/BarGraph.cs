...
public class BarGraph : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        // FIXME: Set the text to the name of this game object
        ...
        {
            signedDisplay = true;
            Vector3 btf = BarTransform.localPosition;
            btf.x = width / 2;
            BarTransform.localPosition = btf;
        }
        // FIXME?: If we're going to display signed numbers, then move the bar to the middle of the widget
    ...
    {
        // FIXME: Determine the color to display it in.
        ...
        else if (value > 0) color = Color.green;
        ...
        // FIXME: Call SetWidthPercent to change the width of the bar and set its color

        // FIXME: Update the text to read: {name} : {value}
    ...
    {
        // FIXME: Set the color of the bar to c
        BarImage.color = c;

        // FIXME: Change BarTransform.localScale so that its x component is scaled by value.
    ...
    public static BarGraph Find(string name, Vector2 position, float min, float max)
    {
        ...
        BarGraphTable.Add(name, null);
        // FIXME: Check if we've already made a bargraph of this name.  If so, return it.
        ...
        // FIXME: Instantiate Prefab and put it inside of the game object that has the canvas.
        ...
        // FIXME: Name the GameObject name
        go.name = name;
    ...
    private static GameObject Prefab
    {
        get
        {
            ...
            // FIXME: return prefab is null, set it to Resources.Load<GameObject>("BarGraph")
